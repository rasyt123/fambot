...
namespace Chess {
    ...
    public:
        ...
        bool MakeMovePlayer(sf::RenderWindow *window, std::string colorturn, std::pair<int, int> startpieceyx, std::pair<int, int> endpieceyx, int prevy, int prevx, Player& currentplayer, bool& promotion);
