    ...
    switch (underboard[y][x])
    {
        case 'P':
            ...
            for (auto item : pawnobj.getpossiblemoves()) {
                std::cout << color << " Pawn" << '{' << item.first << ',' << item.second << '}' << std::endl;
            }
             */
            break;
        case 'R':
            ...
            for (auto item : rookobj.getpossiblemoves()) {
                std::cout << color << " Rook" << '{' << item.first << ',' << item.second << '}' << std::endl;
            }
             */
            break;
        case 'B':
            ...
            for (auto item : bishopobj.getpossiblemoves()) {
                std::cout << color << " Bishop" << '{' << item.first << ',' << item.second << '}' << std::endl;
            }
             */
            break;
        case 'Q':
            ...
            for (auto item : queenobj.getpossiblemoves()) {
                std::cout << color << " Queen" << '{' << item.first << ',' << item.second << '}' << std::endl;
            }
            */
            break;
        case 'K':
            ...
            for (auto item : knightobj.getpossiblemoves()) {
                std::cout << color << " Knight" << '{' << item.first << ',' << item.second << '}' << std::endl;
            }
            */
            break;
        default:
